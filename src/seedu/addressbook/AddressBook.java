...
public class AddressBook {
    ...
    */
    ...
    private static HashMap<PersonProperty,String> makePersonFromData(String name, String phone, String email) {
        ...
        HashMap<PersonProperty,String> hname = new HashMap<>();
        hname.put(PersonProperty.NAME, name); 
        hname.put(PersonProperty.EMAIL, email);
        hname.put(PersonProperty.PHONE, phone);
